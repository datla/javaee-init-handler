...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://ws.kthree.com/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws.kthree.com/", "getServerNameResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.kthree.com/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.kthree.com/", name = "getServerNameResponse")
